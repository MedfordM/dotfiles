...
vim.keymap.set({'n', 'x'}, Layout.movement.END_WORD,  'e')
vim.keymap.set({'n', 'x'}, Layout.movement.LEFT,  'h')
vim.keymap.set({'n', 'x'}, Layout.movement.DOWN,  'j')
vim.keymap.set({'n', 'x'}, Layout.movement.UP,    'k')
vim.keymap.set({'n', 'x'}, Layout.movement.RIGHT, 'l')
